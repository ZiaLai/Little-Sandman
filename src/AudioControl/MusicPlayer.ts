...
export class MusicPlayer {
    ...
    private _startMusic() {
        ...
        let instruments = [
            ...
            new Sound("flute", "./musics/sugarlessBakery/sugarless_bakery-Flute.ogg", this._app.getScene(), soundReady, {loop : true}),
            new Sound("guitar", "./musics/sugarlessBakery/sugarless_bakery-Guitare_electrique.ogg", this._app.getScene(), soundReady, {loop : true}),
